...
ifneq ($(wildcard $(strip $(SOURCE_DIR))/kernel/service/src_core),)
include $(SOURCE_DIR)/kernel/service/src_core/GCC/module.mk
else
LIBS += $(SOURCE_DIR)/kernel/service/lib/libkservice_CM4_MT$(PRODUCT_VERSION)_GCC.a
endif
