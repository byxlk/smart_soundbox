...
CFLAGS 	+= -I$(SOURCE_DIR)/driver/board/mt76x7_hdk/external_flash/inc
...
LIBS += $(SOURCE_DIR)/driver/chip/mt7687/lib/libhal_protected_CM4_GCC.a
endif

include $(SOURCE_DIR)/driver/board/mt76x7_hdk/external_flash/module.mk
