/**********************************************************************
* $Id: lpc18xx_evrt.h 48117 2011-10-20 12:13:01Z anderslu $             lpc18xx_evrt.h                  2011-06-02
*//**
* @file         lpc18xx_evrt.h
...
|| (n==EVRT_SRC_BOD) || (n==EVRT_SRC_WWDT) \
|| (n==EVRT_SRC_ETHERNET) || (n==EVRT_SRC_USB0) \
|| (n==EVRT_SRC_USB1) || (n==EVRT_SRC_CCAN) \
...
typedef enum {
        ...
        EVRT_SRC_BOD,                                   /**< BOD event router source                    */
