...
typedef enum
{
        ...
        //RGU_SIG_PINMUX,                                               /**< Pin mux reset signal               */    //EA ANDLI: According to UM10503 v1.4, bit 10 is reserved
        //RGU_SIG_M3 = 13,                                      /**< Cortex-M3 reset signal             */  //EA ANDLI: M3 does not exist, removed and added M4 instead
  RGU_SIG_M4 = 13,                                      /**< Cortex-M4 reset signal             */
        ...
        //RGU_SIG_AES,                                          /**< AES reset signal                   */        //EA ANDLI: According to UM10503 v1.4, bit 10 is reserved
  RGU_SIG_FLASHA = 25,      /**< FLASH A reset signal */        //EA ANDLI: Added this missing signal
  RGU_SIG_EEPROM = 27,      /**< EEPROM reset signal */        //EA ANDLI: Added this missing signal
        RGU_SIG_GPIO = 28,                                      /**< GPIO reset signal                  */
  RGU_SIG_FLASHB = 29,      /**< FLASH B reset signal */        //EA ANDLI: Added this missing signal
        ...
        RGU_SIG_CAN1,                                   /**< CAN reset signal                   */        //EA ANDLI: Added this missing signal
        RGU_SIG_CAN0=55,                                        /**< CAN reset signal                   */        //EA ANDLI: According to UM10503 v1.4, CAN0 and not CAN
        RGU_SIG_M0APP,                                  /**< M0APP reset signal                 */        //EA ANDLI: Added this missing signal
        RGU_SIG_SGPIO,                                  /**< SGPIO reset signal                 */        //EA ANDLI: Added this missing signal
        RGU_SIG_SPI,                                    /**< SPI reset signal                   */        //EA ANDLI: Added this missing signal
}RGU_SIG;
